    ...
    public function getResult($pollID){
        ...
        if(!empty($pollID)){
            ...
            if(!empty($pollResult)){
                ...
                $sql2 = "SELECT o.id, o.name, v.vote_count FROM ".$this->optTbl." as o LEFT JOIN ".$this->voteTbl." as v ON v.poll_option_id = o.id WHERE o.poll_id = ".$pollID." ORDER BY vote_count DESC";
