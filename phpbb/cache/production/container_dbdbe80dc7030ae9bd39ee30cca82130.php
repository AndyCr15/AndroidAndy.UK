...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'phpbbmk_oauth_tokens', 'phpbbmk_oauth_states', 'phpbbmk_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'phpbbmk_users', $this, $this->get('dispatcher'), './../', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'phpbbmk_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'phpbbmk_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './../', 'php', 'phpbbmk_forums', 'phpbbmk_posts', 'phpbbmk_topics', 'phpbbmk_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('phpbbmk_captcha_questions', 'phpbbmk_captcha_answers', 'phpbbmk_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'phpbbmk_ext', './../', 'php', $this->get('cache'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './../', 'adm/', 'php', 'phpbbmk_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'phpbbmk_migrations', './../', 'php', 'phpbbmk_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), './../', 'php', 'phpbbmk_modules');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'phpbbmk_modules', './../', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\board($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('config'), 'phpbbmk_notification_types', 'phpbbmk_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbbmk_user_notifications');
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('language'), $this->get('user'), 'phpbbmk_notification_types', 'phpbbmk_user_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'phpbbmk_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'phpbbmk_profile_fields', 'phpbbmk_profile_lang', 'phpbbmk_profile_fields_data');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000200b82b6000000001d0b37cf(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'phpbbmk_bbcodes', 'phpbbmk_smilies', 'phpbbmk_styles', 'phpbbmk_words', './../styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description($this->get('dbal.conn'), 'phpbbmk_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules($this->get('dbal.conn'), 'phpbbmk_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description($this->get('dbal.conn'), 'phpbbmk_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text($this->get('dbal.conn'), 'phpbbmk_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title($this->get('dbal.conn'), 'phpbbmk_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text($this->get('dbal.conn'), 'phpbbmk_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature($this->get('dbal.conn'), 'phpbbmk_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './../', 'php', 'phpbbmk_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'tables.acl_groups' => 'phpbbmk_acl_groups',
            'tables.acl_options' => 'phpbbmk_acl_options',
            'tables.acl_roles' => 'phpbbmk_acl_roles',
            'tables.acl_roles_data' => 'phpbbmk_acl_roles_data',
            'tables.acl_users' => 'phpbbmk_acl_users',
            'tables.attachments' => 'phpbbmk_attachments',
            'tables.auth_provider_oauth_token_storage' => 'phpbbmk_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'phpbbmk_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'phpbbmk_oauth_accounts',
            'tables.banlist' => 'phpbbmk_banlist',
            'tables.bbcodes' => 'phpbbmk_bbcodes',
            'tables.bookmarks' => 'phpbbmk_bookmarks',
            'tables.bots' => 'phpbbmk_bots',
            'tables.captcha_qa_questions' => 'phpbbmk_captcha_questions',
            'tables.captcha_qa_answers' => 'phpbbmk_captcha_answers',
            'tables.captcha_qa_confirm' => 'phpbbmk_qa_confirm',
            'tables.config' => 'phpbbmk_config',
            'tables.config_text' => 'phpbbmk_config_text',
            'tables.confirm' => 'phpbbmk_confirm',
            'tables.disallow' => 'phpbbmk_disallow',
            'tables.drafts' => 'phpbbmk_drafts',
            'tables.ext' => 'phpbbmk_ext',
            'tables.extensions' => 'phpbbmk_extensions',
            'tables.extension_groups' => 'phpbbmk_extension_groups',
            'tables.forums' => 'phpbbmk_forums',
            'tables.forums_access' => 'phpbbmk_forums_access',
            'tables.forums_track' => 'phpbbmk_forums_track',
            'tables.forums_watch' => 'phpbbmk_forums_watch',
            'tables.groups' => 'phpbbmk_groups',
            'tables.icons' => 'phpbbmk_icons',
            'tables.lang' => 'phpbbmk_lang',
            'tables.log' => 'phpbbmk_log',
            'tables.login_attempts' => 'phpbbmk_login_attempts',
            'tables.migrations' => 'phpbbmk_migrations',
            'tables.moderator_cache' => 'phpbbmk_moderator_cache',
            'tables.modules' => 'phpbbmk_modules',
            'tables.notification_types' => 'phpbbmk_notification_types',
            'tables.notifications' => 'phpbbmk_notifications',
            'tables.poll_options' => 'phpbbmk_poll_options',
            'tables.poll_votes' => 'phpbbmk_poll_votes',
            'tables.posts' => 'phpbbmk_posts',
            'tables.privmsgs' => 'phpbbmk_privmsgs',
            'tables.privmsgs_folder' => 'phpbbmk_privmsgs_folder',
            'tables.privmsgs_rules' => 'phpbbmk_privmsgs_rules',
            'tables.privmsgs_to' => 'phpbbmk_privmsgs_to',
            'tables.profile_fields' => 'phpbbmk_profile_fields',
            'tables.profile_fields_data' => 'phpbbmk_profile_fields_data',
            'tables.profile_fields_options_language' => 'phpbbmk_profile_fields_lang',
            'tables.profile_fields_language' => 'phpbbmk_profile_lang',
            'tables.ranks' => 'phpbbmk_ranks',
            'tables.reports' => 'phpbbmk_reports',
            'tables.reports_reasons' => 'phpbbmk_reports_reasons',
            'tables.search_results' => 'phpbbmk_search_results',
            'tables.search_wordlist' => 'phpbbmk_search_wordlist',
            'tables.search_wordmatch' => 'phpbbmk_search_wordmatch',
            'tables.sessions' => 'phpbbmk_sessions',
            'tables.sessions_keys' => 'phpbbmk_sessions_keys',
            'tables.sitelist' => 'phpbbmk_sitelist',
            'tables.smilies' => 'phpbbmk_smilies',
            'tables.sphinx' => 'phpbbmk_sphinx',
            'tables.styles' => 'phpbbmk_styles',
            'tables.styles_template' => 'phpbbmk_styles_template',
            'tables.styles_template_data' => 'phpbbmk_styles_template_data',
            'tables.styles_theme' => 'phpbbmk_styles_theme',
            'tables.styles_imageset' => 'phpbbmk_styles_imageset',
            'tables.styles_imageset_data' => 'phpbbmk_styles_imageset_data',
            'tables.teampage' => 'phpbbmk_teampage',
            'tables.topics' => 'phpbbmk_topics',
            'tables.topics_posted' => 'phpbbmk_topics_posted',
            'tables.topics_track' => 'phpbbmk_topics_track',
            'tables.topics_watch' => 'phpbbmk_topics_watch',
            'tables.user_group' => 'phpbbmk_user_group',
            'tables.user_notifications' => 'phpbbmk_user_notifications',
            'tables.users' => 'phpbbmk_users',
            'tables.warnings' => 'phpbbmk_warnings',
            'tables.words' => 'phpbbmk_words',
            'tables.zebra' => 'phpbbmk_zebra',
...
class phpbbtemplatetwiglexer_00000000200b82b6000000001d0b37cf extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a8fe0059608a245324076 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a8fe0059609b011357036 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a8fe00596066896749967 = array(
    ...
    {
        $this->initializer5a8fe0059609b011357036 && ($this->initializer5a8fe0059609b011357036->__invoke($valueHolder5a8fe0059608a245324076, $this, 'set_environment', array('env' => $env), $this->initializer5a8fe0059609b011357036) || 1) && $this->valueHolder5a8fe0059608a245324076 = $valueHolder5a8fe0059608a245324076;

        return $this->valueHolder5a8fe0059608a245324076->set_environment($env);
    }
    ...
    {
        $this->initializer5a8fe0059609b011357036 && ($this->initializer5a8fe0059609b011357036->__invoke($valueHolder5a8fe0059608a245324076, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a8fe0059609b011357036) || 1) && $this->valueHolder5a8fe0059608a245324076 = $valueHolder5a8fe0059608a245324076;

        return $this->valueHolder5a8fe0059608a245324076->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a8fe0059609b011357036 && ($this->initializer5a8fe0059609b011357036->__invoke($valueHolder5a8fe0059608a245324076, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a8fe0059609b011357036) || 1) && $this->valueHolder5a8fe0059608a245324076 = $valueHolder5a8fe0059608a245324076;

        return $this->valueHolder5a8fe0059608a245324076->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a8fe0059609b011357036 = $initializer;
    }
    ...
    {
        $this->initializer5a8fe0059609b011357036 && ($this->initializer5a8fe0059609b011357036->__invoke($valueHolder5a8fe0059608a245324076, $this, '__get', array('name' => $name), $this->initializer5a8fe0059609b011357036) || 1) && $this->valueHolder5a8fe0059608a245324076 = $valueHolder5a8fe0059608a245324076;

        if (isset(self::$publicProperties5a8fe00596066896749967[$name])) {
            return $this->valueHolder5a8fe0059608a245324076->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a8fe0059608a245324076;
    ...
    {
        $this->initializer5a8fe0059609b011357036 && ($this->initializer5a8fe0059609b011357036->__invoke($valueHolder5a8fe0059608a245324076, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a8fe0059609b011357036) || 1) && $this->valueHolder5a8fe0059608a245324076 = $valueHolder5a8fe0059608a245324076;
    ...
    {
        $this->initializer5a8fe0059609b011357036 && ($this->initializer5a8fe0059609b011357036->__invoke($valueHolder5a8fe0059608a245324076, $this, '__isset', array('name' => $name), $this->initializer5a8fe0059609b011357036) || 1) && $this->valueHolder5a8fe0059608a245324076 = $valueHolder5a8fe0059608a245324076;
    ...
    {
        $this->initializer5a8fe0059609b011357036 && ($this->initializer5a8fe0059609b011357036->__invoke($valueHolder5a8fe0059608a245324076, $this, '__unset', array('name' => $name), $this->initializer5a8fe0059609b011357036) || 1) && $this->valueHolder5a8fe0059608a245324076 = $valueHolder5a8fe0059608a245324076;
    ...
    {
        $this->initializer5a8fe0059609b011357036 && ($this->initializer5a8fe0059609b011357036->__invoke($valueHolder5a8fe0059608a245324076, $this, '__clone', array(), $this->initializer5a8fe0059609b011357036) || 1) && $this->valueHolder5a8fe0059608a245324076 = $valueHolder5a8fe0059608a245324076;

        $this->valueHolder5a8fe0059608a245324076 = clone $this->valueHolder5a8fe0059608a245324076;
    }

    public function __sleep()
    {
        $this->initializer5a8fe0059609b011357036 && ($this->initializer5a8fe0059609b011357036->__invoke($valueHolder5a8fe0059608a245324076, $this, '__sleep', array(), $this->initializer5a8fe0059609b011357036) || 1) && $this->valueHolder5a8fe0059608a245324076 = $valueHolder5a8fe0059608a245324076;

        return array('valueHolder5a8fe0059608a245324076');
    }
    ...
    {
        return $this->initializer5a8fe0059609b011357036;
    }
    ...
    {
        return $this->initializer5a8fe0059609b011357036 && ($this->initializer5a8fe0059609b011357036->__invoke($valueHolder5a8fe0059608a245324076, $this, 'initializeProxy', array(), $this->initializer5a8fe0059609b011357036) || 1) && $this->valueHolder5a8fe0059608a245324076 = $valueHolder5a8fe0059608a245324076;
    }
    ...
    {
        return null !== $this->valueHolder5a8fe0059608a245324076;
    }
    ...
    {
        return $this->valueHolder5a8fe0059608a245324076;
    }
