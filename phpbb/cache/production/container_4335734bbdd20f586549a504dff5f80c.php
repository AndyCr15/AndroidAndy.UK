...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000055b3c5bf00000000414c1986(
...
class phpbbtemplatetwiglexer_0000000055b3c5bf00000000414c1986 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a8fe015f3940713358954 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a8fe015f3953274626677 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a8fe015f3917794200739 = array(
    ...
    {
        $this->initializer5a8fe015f3953274626677 && ($this->initializer5a8fe015f3953274626677->__invoke($valueHolder5a8fe015f3940713358954, $this, 'set_environment', array('env' => $env), $this->initializer5a8fe015f3953274626677) || 1) && $this->valueHolder5a8fe015f3940713358954 = $valueHolder5a8fe015f3940713358954;

        return $this->valueHolder5a8fe015f3940713358954->set_environment($env);
    }
    ...
    {
        $this->initializer5a8fe015f3953274626677 && ($this->initializer5a8fe015f3953274626677->__invoke($valueHolder5a8fe015f3940713358954, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a8fe015f3953274626677) || 1) && $this->valueHolder5a8fe015f3940713358954 = $valueHolder5a8fe015f3940713358954;

        return $this->valueHolder5a8fe015f3940713358954->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a8fe015f3953274626677 && ($this->initializer5a8fe015f3953274626677->__invoke($valueHolder5a8fe015f3940713358954, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a8fe015f3953274626677) || 1) && $this->valueHolder5a8fe015f3940713358954 = $valueHolder5a8fe015f3940713358954;

        return $this->valueHolder5a8fe015f3940713358954->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a8fe015f3953274626677 = $initializer;
    }
    ...
    {
        $this->initializer5a8fe015f3953274626677 && ($this->initializer5a8fe015f3953274626677->__invoke($valueHolder5a8fe015f3940713358954, $this, '__get', array('name' => $name), $this->initializer5a8fe015f3953274626677) || 1) && $this->valueHolder5a8fe015f3940713358954 = $valueHolder5a8fe015f3940713358954;

        if (isset(self::$publicProperties5a8fe015f3917794200739[$name])) {
            return $this->valueHolder5a8fe015f3940713358954->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a8fe015f3940713358954;
    ...
    {
        $this->initializer5a8fe015f3953274626677 && ($this->initializer5a8fe015f3953274626677->__invoke($valueHolder5a8fe015f3940713358954, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a8fe015f3953274626677) || 1) && $this->valueHolder5a8fe015f3940713358954 = $valueHolder5a8fe015f3940713358954;
    ...
    {
        $this->initializer5a8fe015f3953274626677 && ($this->initializer5a8fe015f3953274626677->__invoke($valueHolder5a8fe015f3940713358954, $this, '__isset', array('name' => $name), $this->initializer5a8fe015f3953274626677) || 1) && $this->valueHolder5a8fe015f3940713358954 = $valueHolder5a8fe015f3940713358954;
    ...
    {
        $this->initializer5a8fe015f3953274626677 && ($this->initializer5a8fe015f3953274626677->__invoke($valueHolder5a8fe015f3940713358954, $this, '__unset', array('name' => $name), $this->initializer5a8fe015f3953274626677) || 1) && $this->valueHolder5a8fe015f3940713358954 = $valueHolder5a8fe015f3940713358954;
    ...
    {
        $this->initializer5a8fe015f3953274626677 && ($this->initializer5a8fe015f3953274626677->__invoke($valueHolder5a8fe015f3940713358954, $this, '__clone', array(), $this->initializer5a8fe015f3953274626677) || 1) && $this->valueHolder5a8fe015f3940713358954 = $valueHolder5a8fe015f3940713358954;

        $this->valueHolder5a8fe015f3940713358954 = clone $this->valueHolder5a8fe015f3940713358954;
    }

    public function __sleep()
    {
        $this->initializer5a8fe015f3953274626677 && ($this->initializer5a8fe015f3953274626677->__invoke($valueHolder5a8fe015f3940713358954, $this, '__sleep', array(), $this->initializer5a8fe015f3953274626677) || 1) && $this->valueHolder5a8fe015f3940713358954 = $valueHolder5a8fe015f3940713358954;

        return array('valueHolder5a8fe015f3940713358954');
    }
    ...
    {
        return $this->initializer5a8fe015f3953274626677;
    }
    ...
    {
        return $this->initializer5a8fe015f3953274626677 && ($this->initializer5a8fe015f3953274626677->__invoke($valueHolder5a8fe015f3940713358954, $this, 'initializeProxy', array(), $this->initializer5a8fe015f3953274626677) || 1) && $this->valueHolder5a8fe015f3940713358954 = $valueHolder5a8fe015f3940713358954;
    }
    ...
    {
        return null !== $this->valueHolder5a8fe015f3940713358954;
    }
    ...
    {
        return $this->valueHolder5a8fe015f3940713358954;
    }
